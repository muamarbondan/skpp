...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">SKPP Dikirim</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            <h5><i class="icon fas fa-info"></i> Data SKPP Dikirim!</h5>
            Menu ini adalah menu SKPP dari Admin dan disini kamu dapat mengedit atau hapus
        </div>
        </div>
...
<script>
    $(document).ready(function () {
        $(".fetch-table").load("../fetch/table-dikirim.php");
