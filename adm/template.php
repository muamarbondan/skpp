<?php
    ...
    $pesanRead;
    if($countRead > 0) {
        $pesanRead = "Kamu memiliki ".$countRead." unggahan SKPP";
    }else{
        $pesanRead = "Kamu tidak memiliki unggahan";
    }
    $header = " 
    <html lang='en'>
    <head>
    ...
    $nav = "
    <body class='hold-transition sidebar-mini layout-fixed layout-navbar-fixed' onload='MyFunction()'>
    <!------------------------loader------------------------------>
    <div id='loader'>
    ...
    <nav class='main-header navbar navbar-expand navbar-white navbar-light'>
        ...
        <li class='nav-item dropdown' id='sentuhBell'>
            ...
            <div class='dropdown-divider'></div>
            <a href='$url/diterima' class='dropdown-item dropdown-footer'>See All Notifications</a>
            </div>
        </li>
        <li class='nav-item'>
    ...
    <aside class='main-sidebar sidebar-dark-primary elevation-4'>
        ...
        <img src='../saestu.png' alt='Logo Aplikasi' class='brand-image img-circle elevation-3'
            style='opacity: .8'>
        <span class='brand-text font-weight-light'>samiSKPP</span>
        </a>
        ...
        <div class='user-panel mt-3 pb-3 mb-3 d-flex'>
            <div class='image'>
            <img src='../dist/img/customer.png' class='img-circle elevation-2' alt='User Image'>
            </div>
            <div class='info'>
            <a href='#' class='d-block'>Admin samiSKPP</a>
            </div>
        </div>
        ...
        <nav class='mt-2'>
            ...
            <li class='nav-header'>samiSKPP</li>
            <li class='nav-item' id='nav-item'>
                <a href='$url/diterima?status2=active' class='nav-link $_GET[status2]'>
                <i class='nav-icon fas fa-passport' style='color: #38c172'></i>
                <p>
                    SKPP Diterima
                </p>
                </a>
            ...
            <li class='nav-item' id='nav-item'>
                <a href='$url/dikirim?status3=active' class='nav-link $_GET[status3]'>
                <i class='nav-icon fas fa-paper-plane' style='color: #e3342f''></i>
                <p>
                    SKPP Dikirim
                </p>
                </a>
            </li>
            <li class='nav-header'>MANAGEMENT SATKER</li>
            <li class='nav-item' id='nav-item'>
                <a href='$url/database?status4=active' class='nav-link $_GET[status4] bg'>
                <i class='nav-icon fas fa-database' style='color: #f6993f'></i>
                <p>
                    Database
                </p>
                </a>
